...
class EmailDatabaseHelper(context: Context) :
    ...
    companion object {
        ...
        private const val COLUMN_SENDER_MAIL = "sender_mail"
    ...
    fun insertEmail(email: Email) {
        ...
        values.put(COLUMN_SENDER_MAIL, email.senderMail)
    ...
    fun getEmailBySubject(subject: String): Email? {
        ...
        if (cursor.moveToFirst()) {
            email = Email(
                ...
                senderMail = cursor.getString(cursor.getColumnIndex(COLUMN_SENDER_MAIL)),
